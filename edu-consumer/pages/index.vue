      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide" style="background: #040B1B;">
          <a target="_blank" href="/">
            <img src="~/assets/photo/banner/3333.png" alt="首页banner">
          </a>
        </div>
        <div class="swiper-slide" style="background: #040B1B;">
          <a target="_blank" href="/">
            <img src="~/assets/photo/banner/1111.png" alt="首页banner">
          </a>
        </div>
        <div class="swiper-slide" style="background: #040B1B;">
          <a target="_blank" href="/">
            <img src="~/assets/photo/banner/2222.png" alt="首页banner">
          </a>
        </div>
            ...
            <article class="i-teacher-list">
              <ul class="of">
                <li>
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a href="/teacher/1" title="刘进军">
                        <!-- <img alt="姚晨" src="~/assets/photo/teacher/01.jpg"> -->
                        <img alt="刘进军" src="https://edu-lyb-file.oss-cn-beijing.aliyuncs.com/avatar/2019/12/03/d4a7ab4f-9b0e-441a-bba3-527063c4f201.png">
                      </a>
                    </div>
                    <div class="mt10 hLh30 txtOf tac">
                      <a href="/teacher/1" title="刘进军" class="fsize18 c-666">刘进军</a>
                    </div>
                    <div class="hLh30 txtOf tac">
                      <span class="fsize14 c-999">毕业于师范大学数学系，热爱教育事业，执教数学思维6年有余。</span>
                    </div>
                    <div class="mt15 i-q-txt">
                      <p
                        class="c-999 f-fA"
                      >具备深厚的数学思维功底、丰富的小学教育经验，授课风格生动活泼，擅长用形象生动的比喻帮助理解、简单易懂的语言讲解难题，深受学生喜欢。</p>
                    </div>
                  </section>
                </li>
                <li>
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a href="/teacher/1" title="谢敏">
                        <img alt="谢敏" src="https://edu-lyb-file.oss-cn-beijing.aliyuncs.com/avatar/2019/12/03/0cd624c7-e3ee-4fc7-953e-a7f609c472e7.png">
                      </a>
                    </div>
                    <div class="mt10 hLh30 txtOf tac">
                      <a href="/teacher/1" title="谢敏" class="fsize18 c-666">谢敏</a>
                    </div>
                    <div class="hLh30 txtOf tac">
                ...
                <li>
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a href="/teacher/1" title="胡柯">
                        <img alt="胡柯" src="https://edu-lyb-file.oss-cn-beijing.aliyuncs.com/avatar/2019/12/03/d4a7ab4f-9b0e-441a-bba3-527063c4f201.png">
                      </a>
                    </div>

                    <div class="mt10 hLh30 txtOf tac">
                      <a href="/teacher/1" title="胡柯" class="fsize18 c-666">胡柯</a>
                    </div>
                    <div class="hLh30 txtOf tac">
                ...
                <li>
                  <section class="i-teach-wrap">
                    <div class="i-teach-pic">
                      <a href="/teacher/1" title="唐韵">
                        <img alt="唐韵" src="https://edu-lyb-file.oss-cn-beijing.aliyuncs.com/avatar/2019/12/03/0cd624c7-e3ee-4fc7-953e-a7f609c472e7.png">
                      </a>
                    </div>
                    <div class="mt10 hLh30 txtOf tac">
                      <a href="/teacher/1" title="唐韵" class="fsize18 c-666">唐韵</a>
                    </div>
                    <div class="hLh30 txtOf tac">
