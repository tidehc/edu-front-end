    ...
    <section class="container">
      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section id="videoPlay" class="p-h-video-box" style="heigth:400px;width:580px">
...
export default {
  asyncData({ params, error }) {
    return course.getCourseDetailedById(params.id).then(response => {
      return {
        course: response.data.data.courseDetailed,
