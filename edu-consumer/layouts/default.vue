      ...
      <section class="container">
        <div class>
          ...
          <ul class="of flink-list">
            <li>
              <a href="http://www.liuyoubin.top/" title="尚硅谷" target="_blank">何处似樽前</a>
            </li>
          </ul>
          <div class="clear"/>
        </div>
          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>服务热线：XXXXXXXXXXX(深圳)</span>
                <span>Email：734635746@qq.com</span>
              </section>
              <section class="b-f-link mt10">
                <span>©2020课程版权均归在线教育平台所有</span>
              </section>
            </section>
          </section>
